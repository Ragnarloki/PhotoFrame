...
import loadingAnimation from "../assets/uploading.json"; // Lottie file
...
const LoadingScreen = () => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 backdrop-blur-md">
